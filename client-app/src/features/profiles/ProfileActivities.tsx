...
const panes = [
  { menuItem: 'Futures', pane: { key: 'futureEvents' } },
  { menuItem: 'Passées', pane: { key: 'pastEvents' } },
  { menuItem: 'Organisées', pane: { key: 'hosted' } }
];
              ...
              >
                ...
                <Card.Content>
                  ...
                  <Card.Meta textAlign='center'>
                    <div>{format(new Date(activity.date), 'dd/MM')}</div>
